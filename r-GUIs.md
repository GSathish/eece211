...
![A GUI with labeled views]({{ site.url }}/public/images/view-tree-screenshot.png)
...
![A snapshot diagram of the view tree]({{ site.url }}/public/images/view-tree-snapshot.png)
...
+ [A Visual Guide to Swing Components](http://web.mit.edu/6.005/www/sp14/psets/ps4/java-6-tutorial/components.html) (1 page)
...
![The Model-View-Controller Pattern]({{ site.url }}/public/images/mvc.png)
...
![The MVC pattern as shown in a JTextField]({{ site.url }}/public/images/mvc-textfield.png)
...
![The MVC pattern as shown in a filesystem browser]({{ site.url }}/public/images/mvc-filesystem.png)
