...
<div id="factorial-call-stacks" class="pull-margin overflow:scroll">
<table class="table">
<thead>
<tr>
<td><br>`main`</td>
<td colspan="2">calls<br>`factorial(3)`</td>
<td colspan="2">calls<br>`factorial(1)`</td>
<td colspan="2">returns to<br>`factorial(1)`</td>
<td colspan="2">returns to<br>`factorial(3)`</td>
</tr>
<tr>
<td></td>
<td></td>
<td colspan="2">calls<br>`factorial(2)`</td>
<td colspan="2">calls<br>`factorial(0)`</td>
<td colspan="2">returns to<br>`factorial(2)`</td>
<td>returns to<br>`main`</td>
</tr>
</thead>
<tbody class="no-markdown">
<tr>
<td>
  <div class="panel panel-primary"><div class="panel-heading">main</div><div class="panel-body">&nbsp;</div></div>
</td>
<td>
  <div class="panel panel-primary"><div class="panel-heading">factorial</div><div class="panel-body">n = 3<br>&nbsp;</div></div>
  <div class="panel panel-info"><div class="panel-heading">main</div><div class="panel-body">x</div></div>
</td>
<td>
  <div class="panel panel-primary"><div class="panel-heading">factorial</div><div class="panel-body">n = 2<br>&nbsp;</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 3<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">main</div><div class="panel-body">x</div></div>
</td>
<td>
  <div class="panel panel-primary"><div class="panel-heading">factorial</div><div class="panel-body">n = 1<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 2<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 3<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">main</div><div class="panel-body">x</div></div>
</td>
<td>
  <div class="panel panel-primary"><div class="panel-heading">factorial</div><div class="panel-body">n = 0</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 1<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 2<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 3<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">main</div><div class="panel-body">x</div></div>
</td>
<td>
  <div class="panel panel-primary"><div class="panel-heading">factorial</div><div class="panel-body">n = 1<br>r = 1</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 2<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 3<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">main</div><div class="panel-body">x</div></div>
</td>
<td>
  <div class="panel panel-primary"><div class="panel-heading">factorial</div><div class="panel-body">n = 2<br>r = 1</div></div>
  <div class="panel panel-info"><div class="panel-heading">factorial</div><div class="panel-body">n = 3<br>r</div></div>
  <div class="panel panel-info"><div class="panel-heading">main</div><div class="panel-body">x</div></div>
</td>
<td>
  <div class="panel panel-primary"><div class="panel-heading">factorial</div><div class="panel-body">n = 3<br>r = 2</div></div>
  <div class="panel panel-info"><div class="panel-heading">main</div><div class="panel-body">x</div></div>
</td>
<td>
  <div class="panel panel-primary"><div class="panel-heading">main</div><div class="panel-body">x = 6</div></div>
</td>
</tr>
</tbody></table></div>
